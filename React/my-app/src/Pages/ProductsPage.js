...
function ProductsPage({store}) {
    ...
    return (
        <div id="wrapperProductsPage">
            ...
            <br />
                <div>
                   Number of purchases : {store.numOfPurchases}
                </div>
            {store.products.map((product,index) => (
                <Product key={index} product={product} store={store}></Product>
            ))}
            </div>
            ...
            <div id="right">
                ...
                {store.SelectedProductId!==0 &&  <ListCustomerWhoPurchased store={store}/>}
                </div>

                <div id="downRight">
                {store.selectedCustomerId!==0 &&  <AddProductToCurrCustomer store={store}/>}
                </div>
